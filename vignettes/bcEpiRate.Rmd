...
# calculate SMR
smr <- get_smr(count = count_06, popn = popn_06, std_rt = std_rt_06)
smr
```

The number of deaths in the study is `r round(smr * 100, 1)`% of the
number of expected deaths.

The ability to construct confidence intervals will be available in the
future.
